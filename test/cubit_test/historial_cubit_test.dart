    ...
    build: () {
      when(() => mockDonationRepository.getUserDonations())
          .thenAnswer((_) => Stream.fromIterable([UserDonations(
            pendientes: [DonationGroup(donationId: 1, donationStatus: 'pendiente', totalPoints: 100, donationDate: DateTime.now(), donationItems: [])],
            aprobadas: [DonationGroup(donationId: 2, donationStatus: 'aprobada', totalPoints: 200, donationDate: DateTime.now(), donationItems: [])],
            rechazadas: [DonationGroup(donationId: 3, donationStatus: 'rechazada', totalPoints: 300, donationDate: DateTime.now(), donationItems: [])],
          )]));
