  ...
  static final Set<Marker> _markers = {
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'Parroquia de San Jeronimo',
    ...
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'Nuestra Señora de la Salud',
    ...
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'Parroquia Santa Rita de Casia',
    ...
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'Parroquia de San Nicolas de Bari',
          snippet:
    ...
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'Nuestra Señora de la caridad del Cobre',
          snippet:
    ...
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'Parroquia de la Resurrección del Señor',
          snippet:
    ...
    const Marker(
      ...
      infoWindow: InfoWindow(
          title: 'La Gran Plaza Fashion Mall',
          snippet:
